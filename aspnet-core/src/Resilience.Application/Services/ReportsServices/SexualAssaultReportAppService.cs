...
{
    public class SexualAssaultReportAppService : AsyncCrudAppService<SexualAssaultReport, SexualAssaultReportDto, Guid, PagedAndSortedResultRequestDto, SexualAssualtReportRequest, SexualAssaultReportDto>
    {
