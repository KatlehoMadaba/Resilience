...
public abstract class ResilienceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static ResilienceWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(ResilienceWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<ResilienceDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<ResilienceDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<ResilienceDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<ResilienceDbContext, Task<T>> func)
    {
        T result;
