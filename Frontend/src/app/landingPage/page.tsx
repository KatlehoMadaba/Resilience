  ...
  const supportResources: Array<SupportResource> = [
    {
      title: "Secure Login",
      description:
        "Log in anonymously to access Resilience’s secure and confidential platform, free from judgment.",
      icon: <SafetyOutlined className={styles.featureIcon} />,
    },
    {
      title: "Immediate Checklist",
      description:
        "Receive a step-by-step guide on what to do in the critical hours and days.",
      icon: <ClockCircleOutlined className={styles.featureIcon} />,
    },
    {
      title: "Medical Help & Reports",
      description:
        "Find nearby hospitals and generate police reports without having to relive your trauma.",
      icon: <HeartOutlined className={styles.featureIcon} />,
    },
    {
      title: "Emotional Support",
      description:
        "Work through feelings of panic, fear, and overwhelm in a safe, nonjudgmental space.",
          ...
          <Col xs={24} md={14}>
            <div className={styles.missionContent}>
              ...
              <Paragraph className={styles.missionText}>
                At Resilience, we believe that every person deserves support,
                understanding, and the tools to heal. Our platform provides
                safe, confidential access to resources designed specifically for
                survivors.
              </Paragraph>
              <Paragraph className={styles.missionText}>
                Whether you are in crisis or looking for long-term support, our
                community is here to help you navigate each step of your journey
