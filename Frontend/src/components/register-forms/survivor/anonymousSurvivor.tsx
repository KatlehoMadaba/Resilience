...
const AnonymousSignupForm: React.FC = () => {
  ...
  const generatedData = {
    ...
    name: generateRandomString("fname"),
    surname: generateRandomString("lname"),
    emailAddress: `${generateRandomString("anon")}@anonymous.org`,
  };

  // Set initial form values with generated data
  useEffect(() => {
    form.setFieldsValue({
      userName: generatedData.userName,
      name: generatedData.name,
      surname: generatedData.surname,
      emailAddress: generatedData.emailAddress,
      sex: 1,
      recoveryPhase: 1,
      timeElapsedInDays: 0,
